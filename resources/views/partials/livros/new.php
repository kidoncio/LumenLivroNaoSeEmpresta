<div ng-controller="livrosCtrl" ng-scope>
    ...
    <form class="form-horizontal" data-ng-init="getOptions()">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <button id="submit" class="btn btn-success" ng-click="livroSave();"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></button>
